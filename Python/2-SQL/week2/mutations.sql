...
-- A:
--1. Create the employee_expertise .
--2. Define comnposite primary key. The columns employee_id and category_id both serve as primary keys.
--3. Establish foreign key relationships. 
--ie link original tables with new table being created
--FOREIGN KEY (employee_id) REFERENCES employees(employee_id). 
--FOREIGN KEY (category_id) REFERENCES categories(category_id)
--4. Insert Expert Designations
--I can then then insert expert designations with the INSERT statment such as 
--INSERT INTO employee_expertise (employee_id, category_id)
--VALUES (employee_id1, category_id1),
--       (employee_id2, category_id2),
--       (employee_id3, category_id3),
--       ...;
